...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "منصة عمران — نظام تشغيل أعمالك الرقمي" },
      { name: "description", content: "OMRAN Platform — منصة SaaS عربية لإدارة مشاريعك، عملائك، منتجاتك وطلباتك في مكان واحد." },
      { name: "author", content: "OMRAN" },
      { property: "og:title", content: "منصة عمران — OMRAN Platform" },
      { property: "og:description", content: "نظام تشغيل أعمال رقمي للمشاريع الصغيرة والمستقلين والوكالات." },
